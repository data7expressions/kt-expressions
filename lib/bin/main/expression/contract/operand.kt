...
(	val description: String
,   val params:List<ParameterDoc>
)
data class OperatorAdditionalInfo
(	val priority: Int
,   val doc: OperatorDoc?
)
data class FunctionAdditionalInfo
...
class Operand {
	...
	var number:Int?=null
	var id:String?=null
	constructor (pos: Pair<Int,Int>, name:Any, type:OperandType, children:ArrayList<Operand> = arrayListOf<Operand>(), returnType:Type?=null) { 
        this.pos = pos
        this.name = name
        this.type = type
